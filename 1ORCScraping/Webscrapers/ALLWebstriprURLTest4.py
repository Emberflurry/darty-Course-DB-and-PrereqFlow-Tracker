...
xlcsv_urlslist = r"C:\Users\John DeForest\PycharmProjects\dartyclassdb1\1ORCScraping\ORCpageURLs\orcpagelist3.csv"
...
for url in depturlslist:
    ...
    while i < len(specdeptclasses):
        ...
        for class_ in classes:
            ...
            try:
                description = content.find_all("div", attrs={"class": "desc"})[0].p.text.strip()
            except:
                description = ""
            try:
            ...
            sheet1.write(rownumber+1,9,newUrl)
        ...
        print("saving item...")
        wb1.save('orcALL_UGScrape4.xls')
        print("saveSuc")

print("full workbook saved successfully. you may now exit/close.")
wb1.save('orcALL_UGScrape4.xls')
